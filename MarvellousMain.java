...
class MarvellousLogin extends Template implements ActionListener, Runnable {
    ...
    MarvellousLogin() {
        ...
        label3.setBounds(20, 250, l3size.width, l3size.height);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == SUBMIT) {
            if (Validate(value1, value2) == false) {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this, "Short Username", "Aniket Packer Unpacker",
                        JOptionPane.ERROR_MESSAGE);

            }
            if (value1.equals("AniketAdmin") && value2.equals("AniketAdmin")) {
                ...
                attemp--;
                if (attemp == 0) {
                    JOptionPane.showMessageDialog(this, "Number of attempts finished", "Aniket Packer Unpacker",
                            JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
